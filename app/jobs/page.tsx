            ...
            <div className="flex-1">
              ...
              <div className="bg-white rounded-xl p-6 mb-6 border border-purple-200 shadow-sm">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl tracking-tight font-medium text-gray-900">Smart Contract Employment</h3>
                </div>
              ...
              <div className="bg-white rounded-xl p-6 border border-purple-200 shadow-sm">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl tracking-tight font-medium text-gray-900">Global Talent Network</h3>
                </div>
                <p className="text-gray-600 tracking-tight">
