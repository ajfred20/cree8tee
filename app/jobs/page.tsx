...
const JobsPage = () => {
  return (
    <div className="w-full">
      {/* Hero Section */}
      <section className="bg-purple-900 text-white py-20 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-16">
            ...
            <div className="flex-1">
              {/* Feature Box 1 */}
              <div className="bg-purple-800 rounded-xl p-6 mb-6">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold">Smart Contract Employment</h3>
                </div>
              ...
              <div className="bg-purple-800 rounded-xl p-6">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold">Global Talent Network</h3>
                </div>
                <p className="text-purple-100">
      ...
      <section className="py-16 px-4 md:px-8 bg-purple-50 relative overflow-hidden">
        ...
        <div className="absolute top-1/2 right-0 transform -translate-y-1/2 w-64 h-64 bg-purple-200 rounded-full opacity-20 -mr-32"></div>
        <div className="absolute bottom-0 left-1/4 w-48 h-48 bg-purple-300 rounded-full opacity-10"></div>
      </section>
    </div>
  );
};
